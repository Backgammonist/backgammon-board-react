...
export const Checker: React.FC<CheckerProps> = ({ x, y, playerType, totalOnPoint }) => {
    ...
    const yOffset = (y - 1) * baseYOffset * (totalOnPoint > 5 ? 4 / (totalOnPoint - 1) : 1)
    return <circle cx={pos[x].x} cy={pos[x].y + yOffset} r={checkerWidth / 2} stroke={stroke} strokeWidth={checkerStroke} strokeOpacity={1} fill={fill} />
}